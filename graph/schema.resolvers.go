...
// Coursers is the resolver for the coursers field.
// Apesar de ser cursos é um resolver de category
func (r *categoryResolver) Coursers(ctx context.Context, obj *model.Category) ([]*model.Course, error) {
